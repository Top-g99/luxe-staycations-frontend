...
export default function AtalayaVillasNusaPenidaPage() {
  ...
  const roomTypes = [
    ...
    {
      name: "Cliff Villa – Premium",
      price: 850,
      size: "1400 sq ft",
      sleeps: 4,
      view: "Cliff & ocean view",
  ...
  const testimonials = [
    {
      quote: "Atalaya Villas is absolutely breathtaking! The cliff-top location with panoramic ocean views is unmatched. The private infinity pool and attentive staff made our honeymoon unforgettable.",
      author: "David Kim",
      location: "Seoul",
      rating: 5
    },
    {
      quote: "We loved the peaceful atmosphere and stunning views. The villa was immaculate, the food was delicious, and the spa treatments were heavenly. Perfect for a romantic getaway.",
      author: "Maria Santos",
      location: "Rio de Janeiro",
      rating: 5
    },
    {
      quote: "The best villa experience we've ever had! The location is perfect, the service is impeccable, and the views are simply spectacular. We can't wait to return.",
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-6 py-24 sm:py-28 md:py-36 text-left text-white">
          <div className="flex items-center gap-2 text-sm/6 tracking-wide opacity-90 mb-4">
            ...
            <span>/</span>
            <span>Atalaya Villas Nusa Penida</span>
          </div>
            ...
            <div className="h-16 rounded-xl bg-white text-[#171717] shadow-md border border-black/10 px-5 flex flex-col justify-center">
              ...
              >
                ...
                <option>6 Guests, 3 Room</option>
                          ...
                          <Link href="/booking/checkout" className="h-16 rounded-xl bg-[#5a3d35] px-8 text-white font-medium shadow-md whitespace-nowrap flex items-center justify-center hover:bg-[#4a2d25] transition-colors">
                Book Now
              </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h2 className="display text-3xl sm:text-4xl md:text-5xl mb-6">
              Island Luxury with Breathtaking Views
            </h2>
            <p className="text-lg text-black/70 leading-relaxed mb-6">
              Experience island luxury at Atalaya Villas Nusa Penida, a serene escape featuring elegant villas and breathtaking ocean views. Perched on the cliffs of Nusa Penida, our villas offer the perfect blend of modern comfort and natural beauty.
            </p>
            <p className="text-lg text-black/70 leading-relaxed">
              Each villa is thoughtfully designed to maximize the stunning ocean vistas while providing ultimate privacy and comfort. From the infinity pools to the world-class spa, every detail has been crafted to create an unforgettable island retreat. Discover the magic of Nusa Penida at Atalaya Villas.
            </p>
          </div>
      ...
      <section className="bg-[#fafafa] py-16">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            {["All", "Ocean View Villa", "Cliff Villa", "Garden Villa", "Presidential Villa", "Family Villa"].map((type) => (
              <button
                key={type}
