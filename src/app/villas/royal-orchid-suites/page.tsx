...
export default function RoyalOrchidSuitesPage() {
  ...
  const testimonials = [
    {
      quote: "Royal Orchid Suites exceeded our expectations! The location is perfect for exploring Bangkok, the rooms are spacious and elegant, and the rooftop pool offers stunning city views. Highly recommended!",
      author: "Lisa Wang",
      location: "Toronto",
      rating: 5
    },
    {
      quote: "We stayed here for our business trip and couldn't have been happier. The business center is well-equipped, the staff is professional, and the rooms are comfortable and modern. Perfect for both work and leisure.",
      author: "James Wilson",
      location: "Melbourne",
      rating: 5
    },
    {
      quote: "The Royal Orchid Suites is a hidden gem in Bangkok! The service is impeccable, the food is delicious, and the spa treatments are heavenly. We'll definitely be back for our next visit.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <h2 className="display text-3xl sm:text-4xl md:text-5xl mb-6">
              Modern Elegance in the Heart of Bangkok
            </h2>
            <p className="text-lg text-black/70 leading-relaxed mb-6">
              Experience modern elegance and exceptional comfort at Royal Orchid Suites, your perfect retreat for both business and leisure stays. Located in the heart of Bangkok, our suites offer the perfect blend of luxury, convenience, and authentic Thai hospitality.
            </p>
            <p className="text-lg text-black/70 leading-relaxed">
              From our rooftop pool with stunning city views to our world-class spa and fine dining restaurants, every aspect of your stay is designed to exceed expectations. Whether you're visiting for business or pleasure, Royal Orchid Suites provides the perfect base for exploring the vibrant city of Bangkok.
            </p>
          </div>
      ...
      <section className="bg-[#fafafa] py-16">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            {["All", "Deluxe Suite", "Executive Suite", "Garden Suite", "Presidential Suite", "Family Suite"].map((type) => (
              <button
                key={type}
