...
export default function HostSignUp() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // In real app, this would be an API call to register the host
        ...
        <CardContent sx={{ p: 4 }}>
          <Box sx={{ textAlign: 'center', mb: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary">
              Start earning by listing your luxury property
            </Typography>
          </Box>
          ...
          <Box sx={{ textAlign: 'center', mt: 2 }}>
            <Typography variant="body2" color="text.secondary">
              Want to book properties?{' '}
              <Link href="/auth/signup" style={{ color: 'primary.main', textDecoration: 'none' }}>
